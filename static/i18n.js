(() => {
  ...
  const en = {
    ...
    "当前风险": "Current Risk",
    "等待数据": "Waiting",
    "正在读取缓存统计。": "Reading cached statistics.",
    "今日缓存邮件": "Cached Mail Today",
    "当天已写入缓存的邮件数量": "Mail cached today",
    "近 7 天缓存邮件": "Cached Mail in 7 Days",
    "用于判断取信是否持续有数据": "Helps verify mail fetching is still producing data",
    "最新缓存时间": "Latest Cache Time",
    "按邮件接收/缓存时间统计": "Based on received or cached time",
    ...
    "缓存邮件趋势": "Cached Mail Trend",
    "按本机时区汇总当前工作区已缓存邮件，用来确认取信是否持续进入系统。": "Cached mail in the current workspace, grouped by local timezone, to verify mail is still entering the system.",
    "每日缓存邮件趋势": "Daily cached mail trend",
    "暂无缓存趋势数据": "No cached mail trend",
    "邮件分类分布": "Mail Type Distribution",
    "封禁、验证码、安全提醒等缓存邮件类型的占比。": "Distribution of cached mail such as banned notices, verification codes, and security alerts.",
    "暂无邮件分类统计": "No mail type stats",
    "资产概览": "Asset Overview",
    ...
    "缓存邮件": "Cached Mail",
    "暂无邮箱状态统计": "No mailbox status stats",
    ...
    "取信来源分布": "Mail Source Distribution",
    "Outlook、临时邮箱、普通邮箱等来源的缓存邮件数量。": "Cached mail counts by source such as Outlook, temp mail, and generic mail.",
    "Outlook、临时邮箱、其他邮箱等来源的缓存邮件数量。": "Cached mail counts by source such as Outlook, temp mail, and other mail.",
    "暂无取信来源统计": "No mail source stats",
    "邮箱错误类型": "Mailbox Error Types",
    "展示当前邮箱资产上最近记录的错误代码，便于先清理坏邮箱。": "Recent mailbox asset error codes, useful for cleaning bad mailboxes first.",
    "暂无邮箱错误统计": "No mailbox error stats",
    ...
    "失败": "Failed",
    "未检查": "Unchecked",
    "今天已收到封禁/停用邮件，建议优先查看最近封禁邮件和涉及邮箱。": "Banned or deactivated mail arrived today. Review affected recipients first.",
    "近 7 天出现过封禁/停用邮件，建议观察是否集中在某个邮箱域。": "Banned mail appeared in the last 7 days. Check whether it clusters by domain.",
    "当前邮箱池存在异常取信记录，建议先处理错误邮箱再执行批量刷新。": "Some mailboxes have fetch errors. Clean those up before bulk refresh.",
    "当前工作区还没有缓存邮件，仪表盘只能显示资产和刷新结果。": "No cached mail yet in this workspace. The dashboard can only show assets and refresh results.",
    "当前周期内未发现封禁邮件，邮箱缓存仍在正常统计。": "No banned mail found in this range. Cached mail is still being tracked.",
    "无主题": "No subject",
